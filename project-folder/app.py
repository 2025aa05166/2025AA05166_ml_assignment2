...
# -------------------------------------------------
st.markdown(
    "<h1 style='color:#1f2937'>❤️ Heart Disease Prediction App</h1>",
...
# -------------------------------------------------
# Test Dataset Download Link (GitHub)
# -------------------------------------------------

st.markdown(
    """
📥 **Sample Test Dataset (GitHub)**
[Click here to download test.csv](https://raw.githubusercontent.com/2025aa05166/2025AA05166_ml_assignment2/main/project-folder/data/test.csv)
"""
)
...
# Upload CSV
# -------------------------------------------------
st.markdown("### 📂 Upload test CSV file (with `num` column)")
